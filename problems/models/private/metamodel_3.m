...
function [mode, vis_layer] = metamodel_2(dims, omega, in, out, model_options)
    ...
    zpos = [dims(3)-pml_thickness(3)-1, pml_thickness(3)+1] + ...
            size_boost * [-1 1];
    ports = {struct('type', 'wgmode', ...
                    'dir', 'z-', ...
                    'ypol', 1, ...
                    'xpol', 2, ...
                    'pos', {{[1 1 dims(3)-pml_thickness(3)-1], ...
                            [dims(1) dims(2) dims(3)-pml_thickness(3)-1]}}, ...
                    'J_shift', [0 0 -1], ...
                    'E_shift', [0 0 +1]), ...
            struct('type', 'wgmode', ...
                    'dir', 'z+', ...
                    'ypol', 1, ...
                    'xpol', 2, ...
                    'pos', {{[1 1 pml_thickness(3)+1], ...
                            [dims(1) dims(2) pml_thickness(3)+1]}}, ...
                    'J_shift', [0 0 0], ...
                    'E_shift', [0 0 -1])};
% 
